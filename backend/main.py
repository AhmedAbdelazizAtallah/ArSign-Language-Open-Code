...
from backend.api import health, inference, sentence, history, settings, metrics
...
def create_app() -> FastAPI:
    ...
    app.include_router(inference.router, prefix=f"/api/{settings.api_version}", tags=["Inference"])
    app.include_router(sentence.router, prefix=f"/api/{settings.api_version}", tags=["Sentence"])
    app.include_router(history.router, prefix=f"/api/{settings.api_version}", tags=["History"])
    app.include_router(settings.router, prefix=f"/api/{settings.api_version}", tags=["Settings"])
    app.include_router(metrics.router, prefix=f"/api/{settings.api_version}", tags=["Metrics"])
